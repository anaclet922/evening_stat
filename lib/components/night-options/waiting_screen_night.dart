...
import 'package:evening_stat/components/night-options/over.dart';
...
class WaitingScreenNight extends StatefulWidget {
  const WaitingScreenNight({Key? key}) : super(key: key);

  @override
  State<WaitingScreenNight> createState() => _WaitingScreenNightState();
}

class _WaitingScreenNightState extends State<WaitingScreenNight> {
