                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: (){
                                        ...
                                        mySuccessSnackBar(context, Icons.check, "Interest Removed!");
                                      },
                                      child:  const Icon(
                                        Icons.star,
                                        size: 24,
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            context.watch<MainApi>().interests[index].teamHome,
                                          ...
                                          Text(
                                            context.watch<MainApi>().interests[index].teamHomePoints,
                                            overflow: TextOverflow.ellipsis,
                                            style: const TextStyle(
                                                fontSize: 16.0,
                                                color: Colors.white,
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            context.watch<MainApi>().interests[index].teamAway,
                                            overflow: TextOverflow.ellipsis,
                                            style: const TextStyle(
                                                fontSize: 16.0,
                                                color: Colors.white,
                                          ...
                                          Text(
                                            context.watch<MainApi>().interests[index].teamAwayPoints,
                                            overflow: TextOverflow.ellipsis,
                                            style: const TextStyle(
                                                fontSize: 16.0,
                                                color: Colors.white,
